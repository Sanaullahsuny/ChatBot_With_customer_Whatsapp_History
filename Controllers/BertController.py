...
class BertController:
    def __init__(self):
        try:
            ...
            raise RuntimeError(f"Failed to initialize BertController: {str(e)}")
    ...
    def get_model_report(self):
        ...
        try:
            ...
            raise RuntimeError(f"Error generating model report: {str(e)}")
    ...
    def classify_query(self, query):
        ...
        try:
            ...
            raise RuntimeError(f"Error classifying query: {str(e)}")
