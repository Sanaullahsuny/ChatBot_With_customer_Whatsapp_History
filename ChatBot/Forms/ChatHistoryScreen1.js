...
const SERVER_AUDIO_BASE = 'http://192.168.206.173:5001/modelAnswer/';
 const SERVER_AUDIO_BASE_query = 'http://192.168.206.173:5001/userQueries/';
          ...
          <View style={[styles.message, item.sender.includes("user") ? styles.userMessage : styles.botMessage]}>
            ...
            {(item.sender === "bot" || item.sender === "bot-voice") && (
              <View style={{ flexDirection: 'row', alignSelf: 'flex-end', marginTop: 6 }}>
                ...
                <Text style={{backgroundColor:'yellow'}}>User Reply : {item.userreply}</Text>
